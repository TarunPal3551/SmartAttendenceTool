...
public class attendence_predict_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_predict_1);
...
*/
                if (week_no_of_year != third_week) {
                    ...
                    Toast.makeText(attendence_predict_1.this,  "editer can not be opened for more weeks ",
...
//clearing the previus periods from the parent view alraedy present...if its not done new periods will apear along with the already ones
                    ...
                    Toast.makeText(attendence_predict_1.this,  "editer can not be opened for previous weeks ",
                            Toast.LENGTH_SHORT).show();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int     no_of_period = Integer.parseInt(res.getString(2));

        String[] recieved_table_names = myDb_2.get_all_table_names();
...
//percent_tv_java.setText(String.valueOf(table_names[6]));
        ...
        for (i = 0; i < total_no_of_tables; i++) {
            ...
            Cursor res2 = myDb_2.getAllData(corrected_table_names[i]);
            ...
            if (if_week_is_active.equals("WEEK_ACTIVATED")) {
                ...
                for (j = 0; j < 7; j++) {
                    ...
                    Cursor res3 = myDb_2.getAllData(corrected_table_names[i]);
                    res3.move(no_of_period + 1);

                    Cursor res59 = myDb_2.getAllData(corrected_table_names[i]);
                    res59.move( 1);
                    ...
                    if (res3.getString(j + 1).equals("WORKING_DAY") && !res59.getString(j+1).equals( "NOT_OCCURED_YET")) {
                        ...
                        for (m = 0; m < no_of_period; m++) {
                            ...
                            final Cursor res5 = myDb_2.getAllData(corrected_table_names[i]);
                            res5.move(m + 1);
...
/////=======================================================================================================================================================================
 ...
 //#######################################################################################################################################################################
    ...
    private void update_the_bootom_tv() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (String_status_for_days_for_toasts[finalM] == "A") {
                            ...
                            if (status[finalM][finalJ] == "h") {
                                ...
                                Toast.makeText(attendence_predict_1.this, strs[finalJ] + "period is activated and marked absent by default",
                                        Toast.LENGTH_SHORT).show();
                            ...
                            //disable
                            {
                                ...
                                Toast.makeText(attendence_predict_1.this, strs[finalJ] + "period is deactivated/dissmissed/canceled",
                                        Toast.LENGTH_SHORT).show();
                        ...
                        if (String_status_for_days_for_toasts[finalM] == "D") {
                            Toast.makeText(attendence_predict_1.this, "Activate " + Str_arr_for_day_names_toast[finalM] + " first",
                                    Toast.LENGTH_SHORT).show();

                        }

                        if (String_status_for_days_for_toasts[finalM] == "N") {
                            Toast.makeText(attendence_predict_1.this, "attendance can not  be predicted for class that has occured ",
                                    Toast.LENGTH_SHORT).show();
...
//below code is kind of toggling
                            ...
                            if (status[finalM][finalJ] == "p") {
                                ...
                                Toast.makeText(attendence_predict_1.this, strs[finalJ] + " of " + Str_arr_for_day_names_toast[finalM] + "is marked absent",
                                        Toast.LENGTH_SHORT).show();
                             ...
                             //   marked_absent = marked_absent+1;
                                ...
                                Toast.makeText(attendence_predict_1.this, strs[finalJ] + " of " + Str_arr_for_day_names_toast[finalM] + " is marked present",
                                        Toast.LENGTH_SHORT).show();
                ...
                public void onClick(View view) {
                    ...
                    if(String_status_for_days_for_toasts[finalF] != "N") {
                        ...
                        if ( status_for_days[finalF] == "d") {
                            ...
                            Toast.makeText(attendence_predict_1.this, Str_arr_for_day_names_toast[finalF] + " is activated/working day",
                                    Toast.LENGTH_SHORT).show();
...
//                                tv[finalF][h].setBackgroundColor(Color.RED);
                        ...
                        //disable
                        {
                            ...
                            Toast.makeText(attendence_predict_1.this, Str_arr_for_day_names_toast[finalF] + " is deactivated/non working day",
                                    Toast.LENGTH_SHORT).show();
                    ...
                    }else{ Toast.makeText(attendence_predict_1.this,   Str_arr_for_day_names_toast[finalF] +" has occcured ",
                            Toast.LENGTH_SHORT).show();
